...
def get_accuracy(model, mnist_loader):
    r'''
    Method to get the accuaracy for number classification for trained model
    :param model:
    :param mnist_loader:
    :return:
    '''
...
def visualize_pos_embed(model):
    r'''
    method to save the positional embedding cosine similarity map
    Assume number of patched to be 196
    :param model:
    :return:
    '''

    # pos_embed = 1 x Num_patcheds+1 x D
    # Get indices after CLS
